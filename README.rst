...
.. code-block:: bash
  ...
  namespace = "${NAMESPACE}"
  key = "oci-functions-web-automatic-open-close/terraform.tfstate"
  auth = "SecurityToken"
...
.. code-block:: bash
  ...
  repo_waf_open_prefix = "waf_open_mngt"
  repo_waf_close_prefix = "waf_close_mngt"
  repo_com_start_prefix = "com_start_mngt"
  repo_com_stop_prefix = "com_stop_mngt"
  fn_open_name = "waf-open"
  fn_close_name = "waf-close"
  fn_start_name = "compute-start"
  fn_stop_name = "compute-stop"
  fn_open_ocid = ""
  fn_close_ocid = ""
  fn_start_ocid = ""
  fn_stop_ocid = ""
