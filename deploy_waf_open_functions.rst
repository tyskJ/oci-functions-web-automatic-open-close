WAF Request Access Rule Default Action を Allow に変更するFunctionsデプロイ
=====================================================================
.. note::
...
3-2. コード修正
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
* ``~/waf-open`` 配下の各種ファイルの中身を `本フォルダ配下のファイルの中身 <./envs/python/waf-open>`_ に置き換えてください
